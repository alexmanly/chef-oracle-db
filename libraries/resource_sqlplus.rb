...
class Chef
  class Resource
    class SqlPlus < Chef::Resource::LWRPBase
      ...
      attribute :sysdba, :name_attribute => true, :kind_of => String
      attribute :oracle_sid, :name_attribute => true, :kind_of => String
      attribute :oracle_env, :name_attribute => true, :kind_of => String
    end
  end
end